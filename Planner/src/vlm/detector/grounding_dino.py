...
GROUNDING_DINO_CONFIG = "/root/gpufree-data/GroundingDINO-main/groundingdino/config/GroundingDINO_SwinT_OGC.py"
GROUNDING_DINO_WEIGHTS = "/root/gpufree-data/explorer_ws/src/Planner/src/data/groundingdino_swint_ogc.pth"
...
# # export HF_ENDPOINT="https://hf-mirror.com"  配置huggingface镜像源